...
export async function createCustomer(formData: FormData): Promise<ActionResult<Customer>> {
  ...
  const result = await customerService.createFromForm(formValidation.data, user.id);
...
export async function updateCustomer(
  ...
  const result = await customerService.update(id, validation.data, user.id);
...
export async function deleteCustomer(id: string): Promise<ActionResult<Customer>> {
  ...
  const result = await customerService.delete(id, user.id);
...
export async function restoreCustomer(id: string): Promise<ActionResult<Customer>> {
  ...
  const result = await customerService.restore(id, user.id);
